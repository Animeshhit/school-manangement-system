...
import {
  ...
  viewFeesByBranch,
  markFeeAsPaid,
  viewStudentFeePayments,
  viewFeePayments,
  updateStudentFeePayment,
  handlePaymentWebhook,
} from '../controllers/Fee/FeeControllers';
import { authenticateToken, requireNonStudent } from '../middleware/auth';
 ...
 */
router.post('/create', authenticateToken, requireNonStudent, createFee);
 ...
 */
router.post('/webhook/payment-callback', handlePaymentWebhook);
 ...
 */
router.get('/', authenticateToken, viewAllFees);
 ...
 */
router.get('/view/:id', authenticateToken, viewFeeById);
 ...
 *         description: Unauthorized
 */
router.get('/branch/:branchId', authenticateToken, viewFeesByBranch);
 ...
 *         description: Unauthorized
 */
router.get('/class/:branchId/:className', authenticateToken, viewFeesByClass);
 ...
 *         description: Fee not found
 */
router.get('/payments/:feeId', authenticateToken, viewFeePayments);
 ...
 *         description: Unauthorized
 */
router.get('/student-payments/:studentId', authenticateToken, viewStudentFeePayments);
 ...
 *         description: Fee not found
 */
router.put('/:id', authenticateToken, requireNonStudent, updateFee);
 ...
 */
router.post('/mark-paid/:studentId/:feeId', authenticateToken, requireNonStudent, markFeeAsPaid);
 ...
 *         description: Fee not found
 */
router.delete('/:id', authenticateToken, requireNonStudent, deleteFee);
 ...
 *         description: Fee payment record not found
 */
router.put('/payment/:studentId/:feeId', authenticateToken, requireNonStudent, updateStudentFeePayment);
